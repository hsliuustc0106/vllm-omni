...
| --- | --- | --- |
| Configuration | Schema, defaults, deploy/pipeline construction, registry, CLI projection, topology | [configuration.md](../domains/configuration.md) |
| Serving | Public request/response, CLI/API, streaming, output assembly, orchestration, engine lifecycle | [serving.md](../domains/serving.md) |
| Model Executor | Loader, stage input, worker/runner, device startup, AR model execution or data bridge | [model-executor.md](../domains/model-executor.md) |
| Diffusion | Shared pipeline/denoise loop, diffusion scheduler, latent, VAE/DiT, cache, offload or parallelism | [diffusion-checklist.md](../domains/diffusion-checklist.md) |
| Distributed | Connector, KV transfer, collective, load balancing, route/port or cross-stage transport | [distributed.md](../domains/distributed.md) |
| Scheduler | Request queue/state, token budget, KV/input readiness, scheduling coordination or prefix cache | [scheduler.md](../domains/scheduler.md) |
...
| Accelerator, kernel, attention backend, quantization, dtype, scales, or vendor path | [platform-checks.md](../checks/platform-checks.md) and, if runnable, [verification.md](../checks/verification.md) | [`quantization`](../../../quantization/SKILL.md) or [`$vllm-omni-npu-model-runner-upgrade`](../../../vllm-omni-npu-upgrade/SKILL.md) |
...
| User asks who should review or asks to request/ping reviewers | [review-requests.md](../delivery/review-requests.md) | None |
